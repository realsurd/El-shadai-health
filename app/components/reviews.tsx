  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div
          className={`w-10 h-10 ${review.color} rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0`}
        >
          {review.initials}
        </div>
        <div>
        ...
        <div className="lg:hidden mb-8">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 ${reviews[current].color} rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0`}
                >
