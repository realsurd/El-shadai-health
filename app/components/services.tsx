...
import { Home, Activity, UserCheck, Clock, Pill, Car } from 'lucide-react';
...
const services = [
  {
    ...
    description:
      'Compassionate support with Activities of Daily Living including personal hygiene, dressing, grooming, and mobility to maintain your dignity.',
  ...
  },
  {
    ...
    description:
      'Meticulous kitchen care, expert laundry services, and organization that brings cleanliness, order, and tranquility to your living space.',
  ...
  },
  {
    ...
    description:
      'Comprehensive support that empowers independence — from meal planning and medication management to transportation and recreational activities.',
  ...
  },
  {
    ...
    description:
      'From as little as 1 hour a day to around-the-clock care — we adapt to your schedule and evolving needs at every stage.',
  ...
  },
  {
    ...
    description:
      'Ensuring your medications are taken on time and as prescribed, reducing the risk of missed doses and keeping you healthy.',
  ...
  },
  {
    ...
    description:
      'Safe and reliable transportation to medical appointments, social events, and errands — maintaining your independence and connections.',
...
const colorMap: Record<
  string,
  { bg: string; icon: string; badge: string; text: string; border: string }
> = {
  sky: {
    bg: 'bg-sky-50',
    icon: 'text-sky-600',
    ...
    <section id="services" className="py-24 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Discover our diverse array of personalized care programs designed to meet every
            individual need — delivered with compassion and professionalism.
          </motion.p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-12 bg-sky-600 rounded-2xl p-8 text-center text-white"
        >
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <div>
              <p className="font-bold text-lg">Not sure what you need?</p>
              <p className="text-sky-100 text-sm">
                Our care coordinators will assess your needs and build a personalized plan.
              </p>
            </div>
